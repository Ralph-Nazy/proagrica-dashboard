...
import { submitAddUser } from "../../services";
...
const UserForm: React.FC<AddUserModalProps> = ({ isOpen, onClose }) => {
  ...
  const onSubmit = (data: UserFormData) => {
    ...
    //We caling the method we created on our services to advantage of build it API capabilities with NextJS
    submitAddUser(userData)
      .then((response: any) => {
        console.log("user  Response: Even though it returns an empty object:", response);
        setIsSent(true);
        reset();
      })
      .catch((error: any) => {
